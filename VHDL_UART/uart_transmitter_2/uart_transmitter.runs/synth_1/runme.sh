...
HD_PWD='L:/VHDL/Vivado_Projects/uart_transmitter_2/uart_transmitter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_tx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_tx.tcl
