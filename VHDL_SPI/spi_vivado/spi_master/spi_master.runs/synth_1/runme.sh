...
HD_PWD='L:/VHDL/Vivado_Projects/spi_master/spi_master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_master.tcl
